...
int main(){
    ...
    cin >> nilaiMath;
    cout << "Masukkan nilai BhsIndonesia : ";
    cin >> nilaiBindo;
...
cout << "\nStatus kelulusannya : " << status2(rerata(nilaiMath, nilaiBindon, nilaiMath));
cout << "\nStatus kelulusannya : " << status3(rerata(nilaiMath, nilaiBindo));